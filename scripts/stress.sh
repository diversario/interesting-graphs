...
while true; do
  # stress-ng --cpu $cpus --cpu-load $(shuf -i 1-90 -n 1) --matrix $cpus --matrix-size 64 --mergesort $cpus --hdd $cpus --io $cpus --udp $cpus --malloc 8 --malloc-bytes 90% --timeout $(shuf -i 1-20 -n 1)
